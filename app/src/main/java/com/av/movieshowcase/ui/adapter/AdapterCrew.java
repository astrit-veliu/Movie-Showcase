 ...
 */
public class AdapterCrew extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Crew> data;
    private Activity context;


    public AdapterCrew(Activity mContext) {
        data = new ArrayList<>();
        this.context = mContext;
    }

    public void refreshAdapter(List<Crew> data) {
        this.data = data;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (item != null) {
            ...
            viewHolder.txtRole.setText(item.getDepartment());
